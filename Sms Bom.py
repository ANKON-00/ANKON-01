...
\033[1;92m[+] AUTHOR       :   ANKON
\x1b[1;92m[+] FACEBOOK     :   ANKON-00
\x1b[1;92m[+] GITHUB       :   R1F4T-2-0
\x1b[1;12m[+] TEAM         :   ANKON-00
...
if 'love' ==user and 'you'==pas:
        ...
        time.sleep(3)
        os.system('xdg-open https://www.facebook.com/Tomar.golpe.ami.nai.song.aaaaa?mibextid=ZbWKwL')
